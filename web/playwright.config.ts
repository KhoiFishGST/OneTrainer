  ...
  projects: [
    {
      ...
      testMatch:
        /phase-a|phase-b|phase-c|console|theme|responsive-workflows|accessibility|paint-states|dialog-width|gallery-viewer|perf-budget|hover-states|motion|metrics-replay|downloads|typography/,
