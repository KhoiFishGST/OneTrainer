<script lang="ts">
  ...
  const navItems = [
    ...
    { name: 'Model', path: '/model', icon: Box, disabled: true },
    { name: 'Concepts', path: '/concepts', icon: Layers, disabled: true },
    { name: 'Training', path: '/training', icon: Activity, disabled: true },
    { name: 'Sampling', path: '/sampling', icon: Sparkles, disabled: true },
    { name: 'LoRA/Embedding', path: '/lora', icon: Cpu, disabled: true },
