...
TABS = (
    ...
    Tab(
        ...
        "Training",
        (
            # --- COLUMN 1: BASE SETTINGS & TEXT ENCODERS ---
            Group(
                "base_settings",
                "Base Settings",
                (
            ...
            Group(
                ...
                (
                    ...
                    Field(
                        "training-preserve-embedding-norm",
            ...
            # --- COLUMN 2: EXECUTION, DENOISING & NOISE ---
            Group(
                "execution",
            ...
            # --- COLUMN 3: MASKING, LOSS & LAYER FILTERING ---
            Group(
